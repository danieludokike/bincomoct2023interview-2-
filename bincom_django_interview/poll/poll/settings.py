...
SECRET_KEY = 'django-insecure-mla69h8(81-u$bpemtq565c0l25*0#+gpw7r0zcmmj+pug&ucc'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'BincomDB',            # Name of your MySQL database
        'USER': 'root',          # MySQL username
        'PASSWORD': 'securePass123##',      # MySQL password
